...
import com.musicplayer.echo.adapters.MainScreenAdapter
...
class MainScreenFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        playPauseButton = view?.findViewById<ImageButton>(R.id.playPause_button)
        songTitle = view?.findViewById<TextView>(R.id.songTitleMainScreen)
        noSongs = view?.findViewById<RelativeLayout>(R.id.noSongsMainScreen)
